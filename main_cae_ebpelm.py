...
if __name__ == "__main__":
    ...
    IoI = {0: [61000, 62024],
           ...
           14: [50000, 51024],
           15: [19700, 20724]}
    model_path = './models/CAE_model_desync50_epochs200.h5'
    data_path = './ASCAD/ATMega8515_raw_traces.h5'
    traces, pt, key = get_traces(data_path, [0, 100000], 50)
    ...
    for i_byte in range(2,3):
        ...
        caf_elm = ENSEMBLE_BPELM(elm_nodes=1024, bp_epochs=10, bp_lr=[1, 0.1], bp_cp=2, elm_alpha=1, elm_weight_range=[-1, 1],
                                 elm_bias_range=[0, 1])
        ...
        min_trace_number, guess_key, ranks, training_time = \
            caf_elm.train_and_attack(X_profiling=tmp_traces_profiling, pt_profiling=pt_profiling,
                                     ...
                                     pt_attack=pt_attack, focus_key=key_focus[i_byte], byte=i_byte, num_traces=10000,
                                     n_model=3)